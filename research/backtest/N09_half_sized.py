"""
N09_half_sized.py — Noise Kernel: Exit at 0.5 SD instead of 1.0 SD
...
PARAM_DESC = "Exit at 0.5 SD instead of 1.0 SD — known bad"
                        ...
                        if t.side == "LONG":
                            if opens[j] <= t.stop:
                                ...
                                if thru is not None and thru[1] > 0:
                                    ...
                                    if zj >= -0.5:  # exit at 0.5 SD instead of 1.0
